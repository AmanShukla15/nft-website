  ...
  return (
    <div className="flex justify-center sm:p-4 p-12">
      <div className="w-full minmd:w-4/5 ">
        ...
        <div>
          ...
          <div className="relative flex-1 max-w-full flex mt-3" ref={parentRef}>
            <div className="flex flex-row w-max overflow-x-scroll no-scrollbar select-none" ref={scrollRef}>
              ...
              {!hideButtons && (
                <>
                  <div onClick={() => handleScroll('left')} className="absolute w-8 h-8 minlg:h-12 top-45 cursor-pointer left-0 ">
                    <Image src={images.left} layout="fill" objectfit="contain" alt="left_arrow" className={theme === 'light' && 'filter invert'} />
                  </div>
                  <div onClick={() => handleScroll('right')} className="absolute w-8 h-8 minlg:h-12 top-45 cursor-pointer right-0 ">
        ...
        <div className="mt-10">
          <div className="flexBetween  mx-4 xs:mx-10 minlg:mx-8 sm:flex-col sm:items-start ">
